{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOhonUbnLNKMfUkzc4YNB/l",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/EriTeo/Metro-CDMX/blob/main/metro_cdmx.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "moi2qg7Y6P3Y",
        "outputId": "e19caa3a-6893-4ec0-b9c5-e4fbebfde797"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "============================================================\n",
            "🚇 Resultado BFS (Ruta más corta / Costo Unitario):\n",
            "Total estaciones (Costo): 18\n",
            ...
            "============================================================\n",
            "🚇 Resultado BFS (Ruta más corta / Costo Unitario):\n",
            "Total estaciones (Costo): 20\n",
            "Politécnico -> Instituto del Petróleo -> Autobuses del Norte -> La Raza -> Tlatelolco -> Guerrero -> Hidalgo -> Bellas Artes -> Allende -> Zócalo -> Pino Suárez -> San Antonio Abad -> Chabacano -> Viaducto -> Xola -> Villa de Cortés -> Nativitas -> Portales -> Ermita -> General Anaya -> Taxqueña\n",
            "\n",
            "🛤️  Resultado DFS (Ruta explorada en profundidad):\n",
            "Total estaciones (Costo): 39\n",
            "Politécnico -> Instituto del Petróleo -> Lindavista -> Deportivo 18 de Marzo -> La Villa-Basílica -> Martín Carrera -> Talismán -> Bondojito -> Consulado -> Eduardo Molina -> Aragón -> Oceanía -> Romero Rubio -> Ricardo Flores Magón -> San Lázaro -> Morelos -> Tepito -> Lagunilla -> Garibaldi -> Guerrero -> Hidalgo -> Juárez -> Balderas -> Niños Héroes -> Hospital General -> Centro Médico -> Lázaro Cárdenas -> Chabacano -> Jamaica -> Santa Anita -> Coyuya -> Iztacalco -> Apatlaco -> Aculco -> Escuadrón 201 -> Atlalilco -> Mexicaltzingo -> Ermita -> General Anaya -> Taxqueña\n",
            "\n",
            "============================================================\n",
            "Ruta: Zapata -> Oceanía\n",
            "============================================================\n",
            "🚇 Resultado BFS (Ruta más corta / Costo Unitario):\n",
            "Total estaciones (Costo): 13\n",
            "Zapata -> División del Norte -> Eugenia -> Etiopía -> Centro Médico -> Lázaro Cárdenas -> Chabacano -> Jamaica -> Fray Servando -> Candelaria -> San Lázaro -> Ricardo Flores Magón -> Romero Rubio -> Oceanía\n",
            "\n",
            "🛤️  Resultado DFS (Ruta explorada en profundidad):\n",
            "Total estaciones (Costo): 43\n",
            "Zapata -> Parque de los Venados -> Eje Central -> Ermita -> Mexicaltzingo -> Atlalilco -> Escuadrón 201 -> Aculco -> Apatlaco -> Iztacalco -> Coyuya -> Santa Anita -> La Viga -> Chabacano -> Lázaro Cárdenas -> Centro Médico -> Chilpancingo -> Patriotismo -> Tacubaya -> Constituyentes -> Auditorio -> Polanco -> San Joaquín -> Tacuba -> Refinería -> Camarones -> Aquiles Serdán -> El Rosario -> Tezozómoc -> UAM-Azcapotzalco -> Ferrería -> Norte 45 -> Vallejo -> Instituto del Petróleo -> Lindavista -> Deportivo 18 de Marzo -> La Villa-Basílica -> Martín Carrera -> Talismán -> Bondojito -> Consulado -> Eduardo Molina -> Aragón -> Oceanía\n"
          ]
        }
      ],
      "source": [
